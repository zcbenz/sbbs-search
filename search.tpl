...
<title><?php if (!empty($q)) echo "搜索：" . strip_tags($q) . " - "; ?>SBBS 搜索 - Powered by xunsearch </title>
<meta http-equiv="keywords" content="Fulltext Search Engine SBBS xunsearch" />
<meta http-equiv="description" content="Fulltext Search for SBBS, Powered by xunsearch/1.0.1 " />
<style type="text/css">
/* global */
...
<div class="outer">
	<!-- page header -->
	<div id="header"><h1><a href="<?php echo $_SERVER['SCRIPT_NAME']; ?>">SBBS 搜索</a></h1></div>
